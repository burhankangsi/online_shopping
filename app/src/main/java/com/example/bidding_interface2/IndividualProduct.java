...
public class IndividualProduct extends AppCompatActivity {
    ...
    private TextView prod_name, description, quantityView, prod_price, tv_offers, tv_return, tv_rating;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        prod_name = (TextView) findViewById(R.id.productNameIndividualProduct);
        ...
        btn_sub = (Button) findViewById(R.id.decrementQuantity);
        ...
        tv_offers = (TextView)findViewById(R.id.txt_offers_ip);
        tv_return = (TextView)findViewById(R.id.txt_return_within_ip);
        tv_rating = (TextView)findViewById(R.id.txt_rating);
//        prod_price = (TextView)findViewById(R.id.productPriceIndividualProduct);
//        prod_price.setText(item.getPrice());
